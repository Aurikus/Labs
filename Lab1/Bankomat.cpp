...
/*
unsigned operator-(Bankomat Sub,unsigned subtract) // try catch добавить, затестить, если все пойдет по п
{
...
unsigned operator+(Bankomat Sub,unsigned addition) // try catch добавить, затестить, если все пойдет по п
{
